...
🔍 Problem
- 채용공고가 원티드, 사람인, 잡코리아, 리멤버에 분산
- 신규 공고 확인을 위해 매일 반복 조회 필요
- 채용시장 및 요구 역량을 한눈에 파악하기 어려움
...
📈 Result
- 공고 탐색 시간 1시간+ → 10분 이내 단축
- 데이터 분석 채용공고 430건 통합 분석
- 산업군별 요구 역량 및 채용시장 인사이트 도출

## Why?

| 문제 | 해결 | 결과 |
|------|------|------|
| 플랫폼별 공고 분산 | 4개 플랫폼 통합 수집 | 탐색 시간 1시간+ → 10분 |
| 반복적인 신규 공고 확인 | n8n 자동 알림 구축 | 신규 공고 실시간 확인 |
| 채용시장 정보 파편화 | 산업군·스킬 자동 분석 | 430건 데이터 분석 |
